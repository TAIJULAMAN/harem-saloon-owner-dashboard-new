...
export default function DeleteStockModal({ isOpen, onClose, onConfirm }: DeleteStockModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Stock Movement" maxWidth="max-w-sm">
      <div className="flex flex-col items-center text-center pt-4">
        <h3 className="text-[16px] font-bold text-[#1E293B] mb-2">Are you sure?</h3>
        <p className="text-[13px] text-[#64748B] mb-8 px-4">
          This action cannot be undone. This stock movement will be permanently removed.
        </p>
