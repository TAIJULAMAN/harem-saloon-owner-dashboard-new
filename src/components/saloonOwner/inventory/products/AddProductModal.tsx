...
export default function AddProductModal({ isOpen, onClose, onSave }: AddProductModalProps) {
  ...
  const handleSubmit = () => {
    ...
    onSave({
      ...
      priority: "Medium",
      status: parseInt(formData.stockAmount) > 0 ? "In Stock" : "Out of Stock",
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Product" maxWidth="max-w-2xl">
