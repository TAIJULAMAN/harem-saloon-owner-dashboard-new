...
const demoDataByPeriod = {
  "This Month": {
    labels: ["Payroll", "Rent & Utilities", "Supplies", "Marketing", "Other"],
    datasets: [
      {
        data: [45, 25, 15, 10, 5],
        backgroundColor: [
          ...
          <h2 className="text-[16px] font-bold text-[#1E293B] flex items-center gap-2">
            ...
            <div className="group relative cursor-pointer">
              ...
              <div className="absolute left-0 sm:left-1/2 sm:-translate-x-1/2 bottom-full mb-2 hidden group-hover:block w-48 bg-gray-900 text-white text-[11px] p-2 rounded-lg shadow-xl z-10">
                Actionable Insight: Keep payroll under 50% and rent under 15% of total revenue for optimal profitability.
              </div>
            </div>
          </h2>
          <p className="text-[12px] text-[#94A3B8] font-medium mt-1">Percentage distribution of operating costs</p>
        </div>
