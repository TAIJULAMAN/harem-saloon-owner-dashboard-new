...
const demoDataByPeriod = {
  "This Year": {
    ...
    datasets: [
      {
        label: "Total Revenue",
        data: [15000, 16000, 15500, 18000, 17500, 19000, 21000],
        borderColor: "#10B981",
      ...
      {
        label: "Labor Cost",
        data: [6000, 6500, 6400, 7500, 7400, 7800, 8500],
        borderColor: "#EC4899",
  ...
  "Last Year": {
    ...
    datasets: [
      ...
      {
        label: "Labor Cost",
        data: [5000, 5500, 5800, 6000, 6500, 6400, 6800, 7000, 7200, 7800, 8000, 9000],
        borderColor: "#EC4899",
        backgroundColor: "rgba(236, 72, 153, 0.1)",
        fill: true,
        tension: 0.4,
          ...
          <h2 className="text-[16px] font-bold text-[#1E293B] flex items-center gap-2">
            ...
            <div className="group relative cursor-pointer">
              ...
              <div className="absolute left-0 sm:left-1/2 sm:-translate-x-1/2 bottom-full mb-2 hidden group-hover:block w-48 bg-gray-900 text-white text-[11px] p-2 rounded-lg shadow-xl z-10">
                Actionable Insight: Ensure payroll doesn&apos;t exceed 40-50% of revenue to maintain a healthy profit margin.
              </div>
            </div>
          </h2>
          <p className="text-[12px] text-[#94A3B8] font-medium mt-1">Monthly payroll expenditure against earnings</p>
        </div>
