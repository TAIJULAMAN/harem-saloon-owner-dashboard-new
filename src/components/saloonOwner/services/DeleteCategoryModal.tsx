...
export default function DeleteCategoryModal({ isOpen, onClose, onConfirm }: DeleteCategoryModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Category" maxWidth="max-w-sm">
      <div className="flex flex-col items-center text-center pt-4">
        ...
        <p className="text-[13px] text-[#64748B] mb-8 px-4">
          This action cannot be undone. This category and all its mappings will be permanently removed.
        </p>
