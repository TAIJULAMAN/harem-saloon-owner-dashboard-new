...
export default function SignupStep0({ onNext, updateData, data }: Props) {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-2/5 flex flex-col p-8 lg:p-24 bg-white">
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          <h1 className="text-[32px] font-bold text-[#1E293B] font-manrope">Sign up</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-[#64748B] font-manrope">
                I agree to the <Link href="/terms" className="text-[#635BFF] hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-[#635BFF] hover:underline">Privacy Policy</Link>.
              </span>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-[#635BFF] text-white rounded-lg font-bold text-lg hover:bg-[#534dfd] transition-all shadow-lg shadow-[#635BFF]/20 flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[#64748B] font-manrope">or sign up with</span>
            </div>
          </div>
          ...
          <p className="mt-10 text-center text-[#64748B] font-manrope">
            Already have an Account ? <Link href="/login" className="text-[#635BFF] font-bold hover:underline">Sign In Now</Link>
          </p>
        </div>
      </div>
