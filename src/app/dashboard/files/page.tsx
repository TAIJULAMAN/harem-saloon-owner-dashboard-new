...
const mockFolders: FolderData[] = [
  { id: "1", name: "Employees", createdBy: "Maria Rodriguez" },
  { id: "2", name: "Accountant", createdBy: "Maria Rodriguez" },
  { id: "3", name: "Name", createdBy: "Maria Rodriguez" },
  { id: "4", name: "Name", createdBy: "Maria Rodriguez" },
];

const mockFiles: FileData[] = [
  { id: "1", name: "August Salary", type: "PDF", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "2", name: "Sanction", type: "DOC", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "3", name: "Sanction", type: "MP4", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "4", name: "March Salary", type: "MP3", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "5", name: "May Salary", type: "IMG", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "6", name: "Sanction", type: "PPT", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "7", name: "Sanction", type: "ZIP", size: "20 MB", createdBy: "Maria Rodriguez" },
  { id: "8", name: "Sanction", type: "CSV", size: "20 MB", createdBy: "Maria Rodriguez" },
];
...
export default function FilesPage() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 pb-10">
      {/* Header bar */}
      <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-4 sm:p-5 flex items-center h-[72px]">
        <h1 className="text-[1.15rem] font-bold text-[#1E293B] font-manrope">Files</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6 flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <h2 className="text-[15px] font-bold text-[#1E293B] font-manrope">Suggested Folders</h2>
          <Link href="/dashboard/files/folders">
            <button className="px-5 py-2 bg-white border border-[#E2E8F0] rounded-lg text-[13px] font-bold text-[#635BFF] hover:bg-[#F8FAFC] transition-colors">
              View More
            </button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
          {mockFolders.map(folder => (
            <Link href={`/dashboard/files/folders/${folder.id}`} key={folder.id} className="block border border-[#E2E8F0] rounded-lg p-3 flex flex-col gap-3 hover:border-[#CBD5E1] transition-colors group">
              ...
              <div className="px-1 pb-1 flex items-start justify-between">
                ...
                <div className="relative action-dropdown-container">
                  <button
                    onClick={(e) => toggleDropdown(`folder-${folder.id}`, e)}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6 flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <h2 className="text-[15px] font-bold text-[#1E293B] font-manrope">Suggested Files</h2>
        ...
        {viewMode === 'grid' ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {mockFiles.map((file, i) => (
              <div key={file.id + i} className="border border-[#E2E8F0] rounded-lg p-3 flex flex-col gap-3">
